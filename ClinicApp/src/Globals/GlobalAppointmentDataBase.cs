    ...
    public static class GlobalAppointmentDataBase
    {
        ...
        static GlobalAppointmentDataBase()
        {
            ...
            AppointmentList = new List<Appointment>()
            {
                ...
                new Appointment("Abe Jay", "Checkup and X-Ray", new DateTime(2022,12,day2,09,30,0), 30,"Dr. Guy"),
                new Appointment("Josh Richards", "Checkup and consultation", new DateTime(2022,12,day2,10,15,0), 45,"Dr. Wade"),
                new Appointment("Chris Gambino", "Checkup", new DateTime(2022,12,day2,16,30,0), 30,"Dr. James"),
                ...
                new Appointment("Kyle Lino", "Checkup", new DateTime(2022,12,day2,16,30,0), 30,"Dr. James"),
