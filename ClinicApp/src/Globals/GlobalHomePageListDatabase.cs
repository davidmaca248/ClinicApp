...
namespace ClinicApp.Globals
{
    public static class GlobalHomePageListDatabase
    {
        ...
        static GlobalHomePageListDatabase()
        {
            ...
            {
                new NoteListItem(1,"Arhum's test results came in last night", new DateTime(2022,12,day1,9,15,0)),
            ...
            {
                new NoteListItem(1,"Call David Maca to confirm appointment", new DateTime(2022,12,day1,9,15,0)),
                new NoteListItem(2,"Let Dr. Frank know about Arhum's test results", new DateTime(2022,12,day2,9,15,0)),
                ...
                //new NoteListItem("Call David Maca to confirm appointment", new DateTime(2022,12,day2,23,15,0)),
                //new NoteListItem("Let Dr. Frank know about Arhum's test results", new DateTime(2022,12,day2,22,45,0)),
                //new NoteListItem("Let Dr. Josh know about Alden Hoffman's cancellation", new DateTime(2022,12,day2,23,15,0)),
                //new NoteListItem("Let manager know that Dan cannot make it to work today", new DateTime(2022,11,day2,23,15,0)),
            };
        }
    }
}
